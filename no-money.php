...
<body>
    <div id="frame">
        ...
        <section id="main">
            <div id="main-box">
                <div id="idk">
                    <span><div style="font-size:40px;" class="icon-money">Niestety nie posiadasz wystarczającej ilości pieniędzy, aby zakupić tą książkę. Swoje konto możesz doładować w zakładce Profil.</div></span></div>
